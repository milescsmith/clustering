...
def label_clusters(
    ...
    **kwargs
    ...
    resolution : int, default = 1.0
    partition_type : :class:`leidenalg.VertexPartition.MutableVertexPartition`, default = la.RBConfigurationVertexPartition
    n_neighbors : int, default = 30
    random_state : Optional[int], default = None
    neighbor_metric : str, default = "euclidean"
    neighbor_kwds : Optional[Dict[str, Any]], default = None
    neighbor_angular : bool, default = False
    neighbor_verbose : bool, default = True
    fuzzy_metric : str, default = "euclidean"
    fuzzy_metric_kwds : Optional[Dict[str, Any]], default = None
